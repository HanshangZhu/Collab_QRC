...
def main() -> None:
    ...
    if args.headless:
        ...
        except KeyboardInterrupt: log.info("[VLM] Interrupted.")
    else:
    ...
    report = {
        "run": "vlm",
        "provider": vlm_explorer.provider,
    ...
    report_path = Path("/tmp") / f"vlm_report_{time.strftime('%Y%m%d_%H%M%S')}.json"
